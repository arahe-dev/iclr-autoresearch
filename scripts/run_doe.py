...
def main() -> None:
    parser = argparse.ArgumentParser(description="Emit the frozen Generation-0 L8 plus foldover screening design")
    parser.add_argument("--output", type=Path, help="optional path for the full plan JSON")
    parser.add_argument("--execute", action="store_true", help="rejected here; use run_generation0.py for explicit candidate execution")
